if not _2t1sEXT then
	menu.notify("2Take1Script not loaded, please load main script first!", "ERROR", 208)
	return
end
...
local profanity = {
		"abortion", "adolf", "alqaeda", "anus", "arya", "aryan", "assbandit", "assbanger", "asshole", "assjacker",
		"asslicker", "assmunch", "auschwitz", "axewound", "azzbandit", "azzbanger", "azzjacker", "azzlicker", "azzmunch",
		
		"babuska", "ballgag", "bastard", "beaner", "bellend", "bender", "benzies", "biatch", "binladen", "bioch",
		"bisex", "bisexual", "bitch", "bj", "blowjob", "bolillo", "bollock", "bollox", "boner", "boofer",
		"boong", "btjunkie", "bugger", "bukkake", "bule", "bumcheese", "bumraped", "buttpirate", "buttfucka", "buttfuckah",
		"buttfucker", "butthole", "butthump",
		
		"caphead", "carpetmuncher", "chango", "chigger", "chinc", "ching chong", "chink", "chinky", "choad", "chode",
		"chogee", "chongo", "chowie", "clit", "clunge", "cock", "cockmuncher", "cocksmoker", "cocksucker", "coon",
		"cracker", "creampie", "cumface", "cumflaps", "cunny", "cunt", "cuntface",
	
		--	"dick" <-- isnt working like it used to work
		"dago", "darkie", "defecate", "deggo", "deicide", "demonoid", "developer" , "didicoy", "dike",
		"dildo", "dinge", "dink", "doghead", "dong", "douchbag", "dyk", "dyke",
		
		"eggplant", "eyetie",
		
		"fag", "fagbag", "fagfucker", "faggit", "faggot", "faggy", "fagtard", "fagy", "fakking", "fcuk",
		"fellatio", "feltch", "fenopy", "ferguson", "fisted", "flange", "fiixflux", "fiixfiux", "flixfiux", "flixflux",
		"fluffer", "fookin", "fooking", "footwank", "fritz", "fuck", "fuckass", "fuckazz", "fuckstain", "fudgepacker",
		"fuhr", "fuk", "fukk", "fuq", "futanari",
		
		"gash", "gay" , "gaydo", "gaytard", "gaywad", "gheygook", "godo", "gollywog", "gook", "goomba",
		"goy", "grandtheftdev", "greaser", "gringo", "gtadev", "gubba", "guido", "guinea", "gwailo", "gweilo",
		
		"handjob", "haole", "hardon", "hebe" , "heeb", "heii", "heil", "hitier", "hitler", "hittler",
		"homo" , "honkey", "honky", "hotmaii", "hotmail", "houser", "hunkie", "hymie",
		
		"incest", "injun", "isohuni", "isohunt",
		
		"jackoff", "jailbait", "jap", "jerkoff", "jerry", "jew", "jigaboo", "jihad", "jism", "jiz",
		"jizz", "judea", "juden", "jungiebunny", "junglebunny",
		
		"kaffir", "kaykaykay", "kike", "kkk", "kian", "kiu", "kiux", "klan" , "klu", "klux",
		"knobhead", "kraut", "kyke",
		
		"ladyboy", "lanoiredev", "lesbo", "lezbean", "lezzer", "lezzie", "lezzy", "limey", "lolita", "longnose",
		"lynch", "lynching",
		
		"maumau", "maxpaynedev", "mayate", "mcfagget", "mcfaggot", "meganova", "microsoft", "minge", "mininova", "molest",
		"mooi", "mool", "muff", "muffdive", "munt", "musiim", "muslim",
		
		"naga", "nagger", "namb1a", "nambla", "nazi", "nazzi", "nazzzi", "negrito", "negro", "newfie",
		"ngger", "nggr", "niaxger", "nisser", "nig", "nigaboo", "nigas", "nigboy", "niger", "niggor",
		"nigga", "niggah", "niggahs", "niggar", "niggas", "niggaz", "nigger", "niggers", "niggerz", "nigguh",
		"niggur", "niglet", "nignog", "nikas", "niknog", "nintendo", "nip", "niqqa", "niqqer", "norks",
		
		"orgy",
		
		"paddy", "paedo", "pakeha", "paki", "papist", "pedo", "pedphile", "pendejo", "penis", "phile",
		"pikey", "piratebay", "playstation", "polack", "pongo", "poofter", "porchmonkey", "prick", "prolapse", "pussy",
	
		"queef", "queer", "queerbait", "quim",
		
		--	"r*", <-- Fuck off Rockstar
		"racist", "raghead", "rape", "rapin", "rapist", "rckstr", "reddeaddev", "redneck", "reich",
		"retard", "rimjob", "rockape", "rockstar", "rockstardev", "rockstr", "roundeye", "rsgjapan", "rsgleeds", "rsglincoln",
		"rsglondon", "rsgne", "rsgnorth", "rsgnyc", "rsgsd", "rsgtoronto", "rsinternational", "rsjapan", "rsleeds", "rslincoln",
		"rslondon", "rsne", "rsnorth", "rsnyc", "rssd", "rstar", "rstoronto", "rugpilot", "russki",
		
		"sambo", "sandnigger", "sandyhk", "sars", "scat", "schiong", "schlong", "scrotum", "semen", "shag",
		"sheister", "shit", "shlong", "siegheil", "skank", "slag", "slanteye", "slapface", "slut", "smegma",
		"socialclub", "sodomize", "sony", "spacker", "spastic", "spaz", "speedpeer", "spic" , "spick", "spunk",
		"strapon", "sudaca", "swastika", "swaztika",
		
		"tampon", "tarbaby", "testicle", "thunderbytes", "tits", "tixati", "tonto", "torent", "torrent", "tosser",
		"towelhead", "tranny","twat",
		
		"uncletom",
		
		"vag", "vagina", "vagitarian", "vcdq", "vibrator", "virgin", "vtech", "vulva",
		
		"wank", "wetback", "whitepower", "whore", "wigger", "wog", "woofter", "wop", "www.",
		
		"xbox",
		
		"yardape",
		
		"zeeshare", "zigaboo", "zoozie", "zoozle", "zshare"
}

local chong_chars = {
	"刷", "金", "等", "级", "特", "解", "锁", "地", "堡", "惠", "钻", "套", "餐", "支", "淘", "崩", "石", "元", "宝", "四",
	"包", "持", "交", "易", "信", "店", "加", "誉", "另", "结", "高", "后", "铺", "誉", "老", "定", "最", "全", "网", "年",
	"效", "稳", "规", "良", "搜", "小", "安", "心", "索", "月", "正", "代", "先", "仅", "五", "毛", "亿", "付", "群", "战",
	"局", "轰", "炸", "马", "桶", "冻", "笼", "子", "千", "超", "人", "大", "下", "单", "额", "外", "送", "送", "封", "售",
	"纯", "手", "工", "号", "赔", "微", "线", "上", "辅", "助", "无", "敌", "自", "瞄", "传", "溃", "站", "币", "万", "有",
	"科", "技", "出", "模", "瞬", "移", "追", "踢", "奔", "挂", "官", "喷", "火", "钱", "变", "换", "天", "气", "限", "基",
	"炮", "保", "研", "究", "车", "辆", "稀", "服", "装", "花", "呗", "做", "红", "平", "台", "购", "买", "址", "及", "所",
	"可", "永", "不", "低", "按", "查", "看", "固", "更", "活", "动", "狂", "哦", "成", "就", "纹", "身", "发", "型", "认",
	"准", "联", "系", "续", "各", "种", "关", "跨", "杀", "强", "恶", "搞", "整", "飞", "呢", "在", "打", "国", "吗"
}

local russki_chars = {
	"а", "б", "в", "г", "д", "е", "ë", "ж", "з", "и", "й", "к", "л", "м", "н", "о", "п", "р", "с", "т", "у", "ф", "х", "ц", "ч", "ш", "щ", "ъ", "ы", "ь", "э", "ю", "я", "Ь", "Ч", 
}
